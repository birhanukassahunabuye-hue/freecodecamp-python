...
This repository is a collection of practice challenges and curriculum projects completed during my Python study journey on FreeCodeCamp. It tracks my progress from basic data logic to advanced concepts.

---

## Featured Projects

### 1. To-Do List Manager (Final CRUD Version)
...
- **Key Features:**
  - Dynamic storage of names and contact details.
...
- **User Interface:** Building interactive command-line menus.
- **Clean Code:** Using functions and proper naming conventions.
